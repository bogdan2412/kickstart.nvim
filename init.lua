...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gb', require('telescope.builtin').git_branches, { desc = 'search git [B]ranches' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>sS', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace Symbols')
          ...
          map('grk', vim.lsp.buf.signature_help, 'Signature Documentation')
